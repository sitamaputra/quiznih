...
// 3. Replace mobile controls block
const oldMobileControls = `<div className="md:hidden flex items-center gap-4">
            <button className="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white">
              <Menu className="w-6 h-6" />
            </button>
          </div>`;

const newMobileControls = `<div className="md:hidden flex items-center gap-4">
            <button 
...
content = content.replace(oldNavEnd, newNavEnd);

fs.writeFileSync(filePath, content);
console.log('Mobile menu integrated successfully.');
