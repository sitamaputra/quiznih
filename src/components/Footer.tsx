...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-[#FCFF52]/10 mt-24 py-12 relative px-4 sm:px-6 lg:px-8 bg-[#050508]">
      {/* Grid overlay */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold text-lg font-mono tracking-widest text-white">
        ...
        <div className="flex gap-3">
          {[
            ...
            <button key={i} className="p-2.5 rounded-lg border border-[#FCFF52]/10 bg-[#FCFF52]/5 hover:bg-[#FCFF52]/10 text-gray-500 hover:text-[#FCFF52] transition-all">
              {s.icon}
            </button>
          ))}
        </div>
